...
.warning-box {
    background: #fff8e1; border-left: 4px solid #f9ab00;
    border-radius: 8px; padding: 14px 18px; margin: 12px 0;
    font-size: 0.88rem; color: #4a3700;
}
.success-box {
    background: #e6f4ea; border-left: 4px solid #1e8e3e;
    border-radius: 8px; padding: 14px 18px; margin: 12px 0;
    font-size: 0.88rem; color: #0d4e26;
}

.page-title { font-size: 1.65rem; font-weight: 700; color: #0a2342; margin-bottom: 4px; }
